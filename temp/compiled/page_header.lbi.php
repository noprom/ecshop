    ...
    <div class="headerTopArea">
      <div class="headerTop">
        <div class="headerTopLeft">
          <div id="ECS_MEMBERZONE" class="loginArea"><?php 
$k = array (
  'name' => 'member_info',
);
...
?>
          <div id="vanclMap"><a href="<?php echo $this->_var['nav']['url']; ?>" class="mapDropTitle track mapTitle" <?php if ($this->_var['nav']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav']['name']; ?></a></div>
        ...
        <div class="searchLeft">
          ...
          <div class="searchInt">
            <form id="searchForm" name="searchForm" method="get" action="search.php" onSubmit="return checkSearchForm()">
              <input name="keywords" type="text" id="keyword" value="<?php echo htmlspecialchars($this->_var['search_keywords']); ?>" class="searchText ac_input" />
