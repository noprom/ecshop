...
<div class="container" id="idTransformView" style="top: -144px;">
  ...
  <?php $_from = $this->_var['flash']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'flash_0_81059900_1421118159');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['flash_0_81059900_1421118159']):
        $this->_foreach['no']['iteration']++;
?>
    <li><a href="<?php echo $this->_var['flash_0_81059900_1421118159']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['flash_0_81059900_1421118159']['src']; ?>"/></a></li>
  ...
  <ul class="num" id="idNum">
     ...
     <?php $_from = $this->_var['flash']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'flash_0_81074700_1421118159');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['flash_0_81074700_1421118159']):
        $this->_foreach['no']['iteration']++;
?>
     <li>
